    ...
    <div className="float-left w-full">
      <div className="text-[20px] font-bold text-[#000] mb-[20px] w-full float-right">
        <div className="float-right">
          <span
            className="float-left inline-block min-w-[90px] text-center mx-auto rounded-[999px] text-success-500 bg-success-500  text-[16px] font-semibold px-[30px] py-[7px] text-[#fff] cursor-pointer"
